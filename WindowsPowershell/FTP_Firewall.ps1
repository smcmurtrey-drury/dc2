...
# 1. ALLOW FTP Control Port - FROM ANY
...
# This is safe-ish because the Windows Service manages the ports dynamically.
...
Write-Host "FTP Server Hardened & GUI Restored." -ForegroundColor Green