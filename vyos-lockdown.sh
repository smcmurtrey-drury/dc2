...
set firewall name OUTSIDE-IN default-log enable
...
set firewall name OUTSIDE-IN rule 30 destination port 25
set firewall name OUTSIDE-IN rule 30 protocol tcp

set firewall name OUTSIDE-IN rule 31 action accept
set firewall name OUTSIDE-IN rule 31 destination port 110
set firewall name OUTSIDE-IN rule 31 protocol tcp

set firewall name OUTSIDE-IN rule 40 action accept
set firewall name OUTSIDE-IN rule 40 destination port 53
set firewall name OUTSIDE-IN rule 40 protocol udp

set firewall name OUTSIDE-IN rule 41 action accept
set firewall name OUTSIDE-IN rule 41 destination port 53
set firewall name OUTSIDE-IN rule 41 protocol tcp

set firewall name OUTSIDE-IN rule 50 action accept
set firewall name OUTSIDE-IN rule 50 protocol icmp

set firewall name INSIDE-OUT default-action drop
set firewall name INSIDE-OUT default-log enable
...
set firewall name INSIDE-OUT rule 20 destination port 80,443
set firewall name INSIDE-OUT rule 20 protocol tcp

set firewall name INSIDE-OUT rule 21 action accept
set firewall name INSIDE-OUT rule 21 destination port 443
set firewall name INSIDE-OUT rule 21 protocol tcp

set firewall name INSIDE-OUT rule 30 action accept
set firewall name INSIDE-OUT rule 30 destination port 53
set firewall name INSIDE-OUT rule 30 protocol udp

# Strict NTP: Only DC (172.20.240.102) can talk to Google NTP
set firewall name INSIDE-OUT rule 40 description 'Strict NTP for DC'
set firewall name INSIDE-OUT rule 40 action accept
set firewall name INSIDE-OUT rule 40 protocol udp
set firewall name INSIDE-OUT rule 40 destination port 123
set firewall name INSIDE-OUT rule 40 source address '172.20.240.102'
set firewall name INSIDE-OUT rule 40 destination address '216.239.35.0/24'

# Attach firewalls to the external interface
set interfaces ethernet eth0 firewall in name OUTSIDE-IN
set interfaces ethernet eth0 firewall out name INSIDE-OUT
